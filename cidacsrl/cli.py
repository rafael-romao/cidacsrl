...
from cidacsrl.cidacsrl.infra.configs.loader import load_yaml
from cidacsrl.cidacsrl.infra.bootstrappers.indexing_bootstrapper import bootstrap_elasticsearch_indexing
