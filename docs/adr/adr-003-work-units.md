# ADR 003: Gerenciamento Resiliente de Estado com Checkpoints Baseados em Work Units
...
- Relacionada: [ADR 008](adr-008-salvamento-incremental-por-fase.md) (o layout de saída particionado por `phase_match` é o que torna segura a retomada por Work Unit inteira)
